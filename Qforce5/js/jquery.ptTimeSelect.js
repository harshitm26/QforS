...
(function($){
    ...
    jQuery.ptTimeSelect.setTime = function() {
		...
		if(jQuery('#ptTimeSelectUserSelAmPm').text() == "AM")
		{
		
        var tSel = ((Number(jQuery('#ptTimeSelectUserSelHr').text()) + 12)%12).toString()
                    + ":"
		...
		{
			var hr = (Number(jQuery('#ptTimeSelectUserSelHr').text()) + 12).toString();
			if (hr == 24)
				hr = 12;
			var tSel = hr
						+ ":"
